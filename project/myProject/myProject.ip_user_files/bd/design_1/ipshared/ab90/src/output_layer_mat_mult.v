...
// Implemented a state machine for the matrix multiplier    
    ...
    assign A1_read_address = temp_address;
    assign A2_read_address = temp_address;
    assign RES_write_address = temp_address;
    assign RES_write_en = write_en;
    
    wire [31:0] sum;            //accumulator to hold the total sum
